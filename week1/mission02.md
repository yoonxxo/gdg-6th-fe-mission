...
<h1>Hello</h1> //sementic tag를 이용한 경우
```
...
<!DOCTYPE html> 
<html>
  <head>     #title, style, link, script등 메타 데이터 설정
    <meta charset="utf-8">   #검색엔진이 사용할 keywords 정의
    <title>문서 제목</title>
    <link rel="stylesheet" href="style.css"> #외부 CSS파일과 연계
    <style>                 
      body {
